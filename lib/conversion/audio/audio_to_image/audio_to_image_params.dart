class AudioToImageParams {
  final String from;
  final String to;
  final double temperature;
  final String? provider;

  const AudioToImageParams({
    this.from = "Audio",
    this.to = "Image",
  ...
  /// Parameter configuration for Audio to Image conversion
  static List<Map<String, dynamic>> get parametersConfig => [
    ...
    {'name': 'Negative Prompt', 'key': 'negativePrompt', 'type': 'text', 
     'default': ''},
  ];

  AudioToImageParams copyWith({
    String? from,
    String? to,
    double? temperature,
    String? provider,
  }) {
    return AudioToImageParams(
      from: from ?? this.from,
      to: to ?? this.to,
