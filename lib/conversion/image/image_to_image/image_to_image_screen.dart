...
import 'package:pina/conversion/image/image_to_image/image_to_image_logic.dart';
...
class ImageToImageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final logic = ImageToImageLogic();
    final baseParams = ImageToImageParams(temperature: temperature);
    ...
    return ConversionChatScreen(
      ...
      getParametersConfig: () => ImageToImageParams.parametersConfig,
      onSubmit: ({
